...
public class QuestManager_Lagacy : MonoBehaviour
{
    public int questId;
    ...
    Dictionary<int, QuestData_Lagacy> questList;

    void Awake()
    {
        questList = new Dictionary<int, QuestData_Lagacy>();
        GenerateData();
    ...
    {
        questList.Add(10, new QuestData_Lagacy("점거 지역 탐색", new int[] { 2000}));

        questList.Add(20, new QuestData_Lagacy("흔적 조사", new int[] { 2000}));

        questList.Add(30, new QuestData_Lagacy("부하 사살", new int[] { 2000}));

        questList.Add(40, new QuestData_Lagacy("말머리 패거리 정리", new int[] { 2000}));

        questList.Add(50, new QuestData_Lagacy("엔딩", new int[] { 2000 }));
    }
