...
public class TalkManager : MonoBehaviour
{
    ...
    private void GenerateData()         // 기본/퀘스트 대사 추가
    {
        ...
        //2번 퀘스트 : 흔적 조사
        talkData.Add(20 + 2000, new string[] { "정말 거점을 만들었나보군.", "다음 임무다. 거점의 위치를 알았으니 흔적을 찾아와. 그놈들이 사용한 어떤것이라도 상관없어.", "그놈들이 지내고 있다는 물증이 생기면 바로 공격한다.", "혹시 모르니 마주치지 않게 조심하고. 흔적을 모두 찾으면 보고해." });
        talkData.Add(21 + 2000, new string[] { "아직 못찾았나?" });

        //3번 퀘스트 : 부하 사살
        talkData.Add(30 + 2000, new string[] { "흔적의 상태가 처참한걸 보니 놈들도 좋은 상황은 아닌가보군. 약물까지 꼽다니 갈 때까지 갔어.", "이번에 들어온 정보에 의하면 말 머리놈이 자리를 비운 모양이야.", "가서 부하놈들을 상대해주고 오라고."});
